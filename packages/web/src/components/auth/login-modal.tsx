...
export function LoginModal({ isOpen, onClose }: LoginModalProps): React.JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* 모달 콘텐츠 */}
      <div className="relative z-10 w-full max-w-md rounded-lg bg-white p-6 shadow-lg border border-gray-200">
        {/* 닫기 버튼 */}
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-500">Google 계정으로 간편하게 로그인할 수 있습니다</p>
        </div>
      </div>
    </div>
  );
